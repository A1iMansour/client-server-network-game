...
def gamestarted():
    ...
    cumulative_score={key[i]: score[i] for i in indicesofsortedvalues}#sort dictionary based on indices
    ...
    indicesofsortedvalues=np.argsort(score)#get indices of values in ascending order
    scores={key[i]: score[i] for i in indicesofsortedvalues}#sort dictionary based on indices
    ...
    for j in reversed(cumulative_score) :
